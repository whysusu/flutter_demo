class MovieDetailEntity {
	...
	MovieDetailEntity({this.hasSchedule, this.year, this.clips, this.clipUrls, this.currentSeason, this.rating, this.videos, this.scheduleUrl, this.photos, this.pubdates, this.hasTicket, this.durations, this.id, this.ratingsCount, this.photosCount, this.popularReviews, this.images, this.blooperUrls, this.alt, this.collection, this.countries, this.bloopers, this.tags, this.trailers, this.popularComments, this.casts, this.seasonsCount, this.shareUrl, this.commentsCount, this.reviewsCount, this.directors, this.doubanSite, this.mobileUrl, this.title, this.hasVideo, this.subtype, this.genres, this.doCount, this.wishCount, this.pubdate, this.summary, this.website, this.originalTitle, this.languages, this.writers, this.collectCount, this.episodesCount, this.aka, this.trailerUrls, this.mainlandPubdate});
	...
	MovieDetailEntity.fromJson(Map<String, dynamic> json) {
		...
		if (json['photos'] != null) {
			photos = new List<MovieDetailPhoto>();(json['photos'] as List).forEach((v) { photos.add(new MovieDetailPhoto.fromJson(v)); });
		}
		...
		if (json['popular_reviews'] != null) {
			popularReviews = new List<MovieDetailPopularReview>();(json['popular_reviews'] as List).forEach((v) { popularReviews.add(new MovieDetailPopularReview.fromJson(v)); });
		}
		images = json['images'] != null ? new MovieDetailImages.fromJson(json['images']) : null;
		blooperUrls = json['blooper_urls']?.cast<String>();
		alt = json['alt'];
		collection = json['collection'];
		countries = json['countries']?.cast<String>();
		if (json['bloopers'] != null) {
			bloopers = new List<MovieDetailBlooper>();(json['bloopers'] as List).forEach((v) { bloopers.add(new MovieDetailBlooper.fromJson(v)); });
		}
		tags = json['tags']?.cast<String>();
		if (json['trailers'] != null) {
			trailers = new List<MovieDetailTrailer>();(json['trailers'] as List).forEach((v) { trailers.add(new MovieDetailTrailer.fromJson(v)); });
		}
		if (json['popular_comments'] != null) {
			popularComments = new List<MovieDetailPopularCommants>();(json['popular_comments'] as List).forEach((v) { popularComments.add(new MovieDetailPopularCommants.fromJson(v)); });
		}
		if (json['casts'] != null) {
			casts = new List<MovieDetailCast>();(json['casts'] as List).forEach((v) { casts.add(new MovieDetailCast.fromJson(v)); });
		}
		...
		if (json['writers'] != null) {
			writers = new List<MovieDetailWriter>();(json['writers'] as List).forEach((v) { writers.add(new MovieDetailWriter.fromJson(v)); });
		}
	...
	Map<String, dynamic> toJson() {
      ...
      data['popular_reviews'] =  this.popularReviews.map((v) => v.toJson()).toList();
    }
		if (this.images != null) {
      ...
      data['popular_comments'] =  this.popularComments.map((v) => v.toJson()).toList();
    }
		if (this.casts != null) {
...
//	MovieDetailRating({this.average, this.min, this.max, this.details, this.stars});
	MovieDetailRating({ this.min, this.max,  this.stars});

	MovieDetailRating.fromJson(Map<String, dynamic> json) {
//		average = json['average'];
		min = json['min'];
		max = json['max'];
//		details = json['details'] != null ? new MovieDetailRatingDetails.fromJson(json['details']) : null;
		stars = json['stars'];
	}
...
//	double 5;
//
//	MovieDetailRatingDetails({this.1, this.2, this.3, this.4, this.5});
//
...
class MovieDetailPhoto {
	...
	MovieDetailPhoto({this.cover, this.image, this.thumb, this.alt, this.icon, this.id});
...
class MovieDetailPopularReview {
	...
	MovieDetailPopularReview({this.subjectId, this.summary, this.author, this.rating, this.alt, this.id, this.title});

	MovieDetailPopularReview.fromJson(Map<String, dynamic> json) {
		subjectId = json['subject_id'];
		summary = json['summary'];
		author = json['author'] != null ? new MovieDetailPopularReviewsAuthor.fromJson(json['author']) : null;
		rating = json['rating'] != null ? new MovieDetailPopularReviewsRating.fromJson(json['rating']) : null;
		alt = json['alt'];
		id = json['id'];
		title = json['title'];
	}
...
class MovieDetailPopularReviewsAuthor {
	...
	MovieDetailPopularReviewsAuthor({this.uid, this.signature, this.alt, this.name, this.avatar, this.id});
...
//	MovieDetailPopularReviewsRating({this.min, this.max, this.value});
	MovieDetailPopularReviewsRating({this.min, this.max});
...
class MovieDetailBlooper {
	...
	MovieDetailBlooper({this.subjectId, this.small, this.resourceUrl, this.alt, this.medium, this.id, this.title});
...
class MovieDetailTrailer {
	...
	MovieDetailTrailer({this.subjectId, this.small, this.resourceUrl, this.alt, this.medium, this.id, this.title});
...
class MovieDetailPopularCommants {
	...
	MovieDetailPopularCommants({this.subjectId, this.author, this.rating, this.createdAt, this.id, this.usefulCount, this.content});

	MovieDetailPopularCommants.fromJson(Map<String, dynamic> json) {
		subjectId = json['subject_id'];
		author = json['author'] != null ? new MovieDetailPopularCommentsAuthor.fromJson(json['author']) : null;
		rating = json['rating'] != null ? new MovieDetailPopularCommentsRating.fromJson(json['rating']) : null;
...
class MovieDetailPopularCommentsAuthor {
	...
	MovieDetailPopularCommentsAuthor({this.uid, this.signature, this.alt, this.name, this.avatar, this.id});
...
//	MovieDetailPopularCommentsRating({this.min, this.max, this.value});
	MovieDetailPopularCommentsRating({this.min, this.max});
...
class MovieDetailCast {
	...
	MovieDetailCast.fromJson(Map<String, dynamic> json) {
		...
		alt = json['alt'];
		id = json['id'];
		avatars = json['avatars'] != null ? new MovieDetailCastsAvatars.fromJson(json['avatars']) : null;
		nameEn = json['name_en'];
	}
...
class MovieDetailDirector {
	...
	MovieDetailDirector({this.name, this.alt, this.id, this.avatars, this.nameEn});

	MovieDetailDirector.fromJson(Map<String, dynamic> json) {
		name = json['name'];
		alt = json['alt'];
		id = json['id'];
		avatars = json['avatars'] != null ? new MovieDetailDirectorsAvatars.fromJson(json['avatars']) : null;
		nameEn = json['name_en'];
	}
...
class MovieDetailWriter {
	...
	MovieDetailWriter.fromJson(Map<String, dynamic> json) {
		...
		alt = json['alt'];
		id = json['id'];
		avatars = json['avatars'] != null ? new MovieDetailWritersAvatars.fromJson(json['avatars']) : null;
		nameEn = json['name_en'];
	}
